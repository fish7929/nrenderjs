    ...
    var article = {
        "pages"  : [
            ...
            <MePage idx={1} cxt={cxt}
                ...
                <MeAnimation cxt={cxt} listenEvt={{active:"page[1]:active",deactive:"page[1]:deactive"}}
                             normalStyle={{top:"200px"}} animationClass="fadeInUp">
                    <div style={{fontSize:"46px",fontFamily:"css-font-111"}}>2015年7月25日<p>夏天，很热打扫我们</p><p>
                        即将要开始新生活的住所</p></div>
                </MeAnimation>
            </MePage>,
            <MePage idx={2} cxt={cxt}
                    normalStyle={{backgroundColor:"gray",backgroundImage:'url("http://ac-hf3jpeco.clouddn.com/312ab77435c7d2b06bad.jpg?imageView2/2/format/jpg/w/600/h/800")'}}></MePage>,
            <MePage idx={3} cxt={cxt}
                ...
                <MeAnimation cxt={cxt} listenEvt={{active:"page[3]:active",deactive:"page[3]:deactive"}}
                             normalStyle={{top:"20px",height:"100px"}}>
            ...
            <MePage idx={4} cxt={cxt} normalStyle={{backgroundColor:"pink"}}>
                    <MeLabel normalStyle={{left: "224px", top: "361px", width: '190px', height: '52px', border : "2px solid rgb(0, 0, 0)",
					 borderRadius : "40px", fontSize:"30px", color:"rgb(255,102,0)", backgroundColor:"#000"}} id={"meCheckbox147"}
					 data={{
						content: "方向左的",
						type : "地点",
						typeImg : "http://ac-hf3jpeco.clouddn.com/3bce28861e082296e8b7.png",
						direction: "left" }} pageIdx={6} cxt={cxt} ></MeLabel>
					<MeLabel normalStyle={{left: "84px", top: "400px", width: '480px', height: '361px', border : "2px solid rgb(0, 0, 0)",
					 borderRadius : "10px", fontSize:"30px", color:"rgb(255,102,0)", backgroundColor:"#000"}} id={"meCheckbox147"}
					 data={{
						title: "喜欢的明星",
						options : ["刘德华","胡歌","马伊俐"],
						objectId : "574bf4e1a3413100591d2125"}} pageIdx={6} cxt={cxt} ></MeLabel>
            </MePage>,
            <MePage idx={5} cxt={cxt} normalStyle={{backgroundColor:"pink"}}>
<<<<<<< HEAD
                <MeSvg normalStyle={{left: "50px", top: "50px",width: '320px', height: '320px'}} id={"mesvg1111"} pageIdx={5} cxt={cxt}
                data={{
